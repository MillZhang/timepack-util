...
var _moxie = require('./qiniu/moxie.js');

var _moxie2 = _interopRequireDefault(_moxie);

var _pluploadFullMin = require('./qiniu/plupload.full.min.js');

var _pluploadFullMin2 = _interopRequireDefault(_pluploadFullMin);

var _qiniu = require('./qiniu/qiniu.js');
...
var TimepackUtil = function () {
    ...
    _createClass(TimepackUtil, [{
        ...
        key: 'removeArrayItem',
        value: function removeArrayItem(array, index) {
